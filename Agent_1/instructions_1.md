...
3. Modeling and Inference: both basic statistical modeling (match result as random independent variable) as well as ML-oriented analyses.
...
3b. Bookmaker Accuracy: Bet365 vs William Hill, accuracy and P and L. Which loses you the least money?
